  ...
  Widget build(BuildContext context) {
    return SingleChildScrollView(
      ...
      child: GridView.builder(
        scrollDirection: Axis.horizontal, // Menetapkan arah scroll ke horizontal
        gridDelegate: const SliverGridDelegateWithFixedCrossAxisCount(
          crossAxisCount: 1, // Set menjadi 1 untuk membuatnya berbaris secara horizontal
          childAspectRatio: 1.6, // Atur rasio aspek agar kotak grid berbentuk persegi
        ...
        itemBuilder: (context, index) {
          return Container(
            ...
            child: Column(
              ...
              children: [
                Icon(Icons.music_note, color: Colors.white, size: 128), // Mengubah ukuran ikon
